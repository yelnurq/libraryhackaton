    ...
    <div class="all-books">
        <div class="book-nav">
            <ul>
                ...
                <li><a style="color:#e35e00; cursor" href="{{route("books.process")}}">В процессе</a></li>
                <li><a  href="{{route("books.wishlist")}}">Желаемое</a></li>
            </ul>
        </div>
        <div class="popular-books">
                <p class="popular-books-p">Книги в процессе чтения</p>
                @if($processBooks->isEmpty())
                    <p style="text-align: center; margin-top:30px;">У вас нет книг в процессе чтения.</p>
                @else
            <ul>
                @foreach($processBooks as $status)
